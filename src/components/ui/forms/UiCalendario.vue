    ...
    <Teleport to="body">
      ...
      >
        ...
        >
            ...
            >
              ...
              <button
                ...
                :class="{
                  ...
                  'ring-2 ring-[var(--color-primary)] font-semibold': day.isToday && !isSelected(day.date) && !isDisabled(day.date),
                  '!bg-[var(--color-primary)] !text-white font-semibold hover:!bg-[var(--color-primary-dark)]': isSelected(day.date),
          ...
          <div v-if="range" class="p-3 border-t border-[var(--color-border)] bg-[var(--color-background)]">
