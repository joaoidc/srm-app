...
declare global {
  ...
  import('vue')
  // @ts-ignore
  export type { DashboardData, StatItem, SummaryItem, TableItem, AniversarianteItem, AtendenteItem, AtendimentosVencidos, ChartData } from '../../src/layers/dashboard/stores/dashboard'
